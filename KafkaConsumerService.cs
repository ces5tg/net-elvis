...
public class KafkaConsumerService : BackgroundService
{
    ...
    {
        _logger = logger;
        _topic = "ideas";  // Cambia esto al nombre de tu tópico
        _bootstrapServers = "localhost:9092";  // Cambia esto a la dirección de tu servidor Kafka

        _httpClient = new HttpClient();
        _httpClient.BaseAddress = new Uri("http://localhost:5012"); // Reemplaza con la URL base de tu API
    }
